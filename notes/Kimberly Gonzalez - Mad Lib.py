...
print("People should go to college because it helps you get %s, options, and ." % place9, place10)
print(" First, a degree gives you better chances to get a %s paying job." % place10)
